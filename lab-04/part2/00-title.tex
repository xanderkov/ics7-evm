\begin{titlepage}
	...
	\begin{center}
		...
		\Large\textbf{\textsc{по части практикума №1}}\\
	\end{center}
	
	\vspace{1cm}
	
	\noindent\textnormal{Название:} \hspace{15mm} \underline{\textnormal{~~~Изучение принципов работы микропроцессорного ядра RISC-V~~~}}\noindent
	
	\vspace{1.3cm}
	
	\noindent\textnormal{Дисциплина:} \hspace{10mm} \underline{\textnormal{~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Архитектура ЭВМ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~}}\noindent
	...
	\noindent\underline{\textnormal{~~~~~А. Ю. Попов~~~~~}}
